/*Écris une fonction JavaScript filterByTitle qui prend en paramètre un tableau d'objets movies 
et une chaîne de caractères searchedTitle .
 Cette fonction doit retourner un nouveau tableau contenant uniquement l
 es objets dont la propriété title contient la chaîne de caractères searchedTitle 
...
const recentMovies = [
  {
    title: "The Great Adventure", //To lowercase sert a faire en sorte que la recherche soit insensible a la casse//
